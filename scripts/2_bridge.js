...
async function main() {
  ...
  await (await bridgeContract.withraw(coinAddress, await bridgeContract.balanceCrossChainFee(coinAddress))).wait()
  ...
  await (await bridgeContract.withraw(erc20.address, await bridgeContract.balanceCrossChainFee(erc20.address))).wait()
  ...
  await (await bridgeContract.withraw(ccnwrap.address, await bridgeContract.balanceCrossChainFee(ccnwrap.address))).wait()
